---
title: "Left Angle Cross of the Four Ways 1"
section: "Incarnation Cross"
related: []
---

# Left Angle Cross of the Four Ways 1
...
A Left Angle Cross is a karmic destiny. The Left Angle Four Ways 1 carrier is here to live four 18.6-year nodal cycles, but the cycles are not for them. Each cycle delivers the carrier into a different transpersonal function. In one cycle the carrier may be the public thinker; in another, the silent advisor; in another, the historian; in another, the elder. Ra was clear that the carrier themselves may feel chronically misaligned even as their life is producing direction for everyone around them.

The not-self distortion is the carrier who treats the misalignment as personal failure, who fights the nodal turn, or who tries to extract personal meaning from a karmic mechanism. The correct expression accepts the asymmetry. The four ways are the species' alignment. The carrier is the body through which the alignment is delivered.
...
- **4/6** the externalising thinker whose returns are processed through a stable network across three life phases
- **5/1** the projected practical thinker called by collective crisis to return to the unresolved question
- **5/2** the projected hermit-thinker whose solitude is interrupted by the projection of the community
- **6/2** the role-model hermit-thinker who matures into the elder whose nodal returns become the community's wisdom
- **6/3** the role-model trial-and-error thinker whose public failures and recoveries become the species' instruction in how to think
